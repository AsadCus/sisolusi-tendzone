...
const badgeStyles: Record<string, string> = {
  bestselling: "bg-emerald-50 text-emerald-600 border border-emerald-200",
  hot: "bg-red-50 text-red-500 border border-red-200",
      ...
      <div className="max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto px-4">
        ...
        <div className="text-center max-w-6xl mx-auto mb-8">
          ...
          <div className="flex justify-center mt-3 mb-6">
            <span className="block w-12 h-1 bg-red-500" />
          </div>
              ...
              <Card className="h-full overflow-hidden rounded-none border border-gray-100 bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div className="relative h-56 w-full bg-gray-50 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
                    ...
                    {category.logo ? (
                      <div className="relative h-6 w-16 bg-white/80 backdrop-blur-sm p-0.5">
                        <Image
                          src={category.logo}
                ...
                <CardContent className="p-5 flex flex-col gap-3">
                  ...
                  <div className="mt-1 flex items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    <span className="flex items-center justify-center w-7 h-7 border border-gray-200 group-hover:border-red-500 group-hover:bg-red-500 transition-all duration-300">
