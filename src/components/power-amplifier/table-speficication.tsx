...
export default function PowerAmplifierSpecificationTable() {
  const sections = [
    {
      title: "General Performance",
      rows: [
        { param: "Number of Channels", value: "8" },
        { param: "Stereo Mode @8Ω, each channel", value: "150W" },
        { param: "Stereo Mode @4Ω, each channel", value: "250W" },
        { param: "Frequency Response", value: "20Hz – 20kHz (±3dB)" },
        { param: "Signal-to-Noise Ratio (S/N)", value: "≥80dB" },
        { param: "Total Harmonic Distortion", value: "≤0.05% (8Ω, 150W)" },
        ...
        { param: "Output (CH1–2)", value: "XLR Output Connectors" },
      ],
    },
  ]
