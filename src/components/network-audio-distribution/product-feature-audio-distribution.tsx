    ...
    <section className="w-full bg-white py-12">
      <div className="max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto px-4">
        ...
        <div className="flex justify-center mb-16">
          <div className="inline-flex border border-gray-200 overflow-hidden divide-x divide-gray-200">
            {products.map((p) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-2.5 text-sm font-medium transition-all duration-200 whitespace-nowrap focus:outline-none ${active === p.id
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Badge className="bg-red-50 text-red-500 border border-red-100 hover:bg-red-100 gap-1.5 px-3 py-1 text-xs font-medium rounded-none">
            ...
            <ul className="space-y-2">
              {product.features.map((f) => (
                <li
                  key={f.title}
                  className="flex items-start gap-3 px-3 py-2.5 border border-transparent hover:border-t-red-300 hover:border-t-2 hover:border-x-transparent hover:border-b-transparent hover:bg-red-50/40 transition-all duration-200 group"
                >
          ...
          <div className="bg-white border border-gray-100 p-10 flex items-center justify-center sticky top-24">
            <Image
              src={product.image}
