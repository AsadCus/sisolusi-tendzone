...
const PRODUCTS: Product[] = [
  {
    ...
    image:
      "https://www.tendzone.net/uploads/43135/small/distributor-audio-over-ip-system.jpg?size=380x0",
  },
  {
    id: 2,
    ...
    slug: "network-audio-distribution",
    description:
      "Amber NV880 is a distributed network audio input and output node.",
    image:
      "https://www.tendzone.net/uploads/43135/small/8x8-vailink-i-o-interface.jpg?size=380x0",
  ...
  },
  {
    ...
    slug: "network-audio-distribution",
    description:
      "Amber NV200 is a network adapter independently developed by Tendzone.",
    image:
      "https://www.tendzone.net/uploads/43135/small/vailink-2ch-analog-input-adapter.jpg?size=380x0",
  },
  {
    id: 4,
    ...
    slug: "network-audio-distribution",
    description:
      "The Amber NV020 is a network adapter developed independently by Tendzone.",
    image:
      "https://www.tendzone.net/uploads/43135/small/vailink-2ch-analog-output-adapter.jpg?size=380x0",
  },
  {
    id: 5,
    ...
    slug: "network-audio-distribution",
    description:
      "Amber NV 22U is a node of the distributed network audio system.",
    image:
      "https://www.tendzone.net/uploads/43135/small/vailink-2x2-uac-adapter.jpg?size=380x0",
  },
  {
    id: 6,
    ...
    slug: "network-audio-distribution",
    description:
      "Amber MV600 is a desktop rectangular columnar condenser microphone.",
    image:
      "https://www.tendzone.net/uploads/43135/small/vailink-rectangular-columnar-condenser-microphone.jpg?size=380x0",
  },
  {
    id: 7,
    ...
    slug: "network-audio-distribution",
    description:
      "G15C/FV is a cardioid condenser gooseneck microphone suitable for professional use.",
    image:
      "https://www.tendzone.net/uploads/43135/small/vailink-desktop-embedded-gooseneck-condenser-microphone.jpg?size=380x0",
  },
  {
    id: 8,
    ...
    slug: "network-audio-distribution",
    description:
      "Amber series powered speakers are designed for intelligent network systems.",
    image:
      "https://www.tendzone.net/uploads/43135/small/4-5-vailink-network-powered-column-speaker.jpg?size=380x0",
  },
  {
    id: 9,
    ...
    slug: "network-audio-distribution",
    description:
      "Amber SM8 powered speakers are designed for smart network systems.",
    image:
      "https://www.tendzone.net/uploads/43135/small/8-vailink-network-powered-full-range-speaker.jpg?size=380x0",
  },
  {
    id: 10,
    ...
    slug: "network-audio-distribution",
    description:
      "The Amber SM12 powered speaker is designed for smart network systems.",
    image:
      "https://www.tendzone.net/uploads/43135/small/12-vailink-network-powered-full-range-speaker.jpg?size=380x0",
  },
  {
    id: 11,
    ...
    slug: "network-audio-distribution",
    description:
      "Utilizing TENOZONE's exclusive audio processing technology, this series delivers clarity.",
    image:
      "https://www.tendzone.net/uploads/43135/small/6-vailink-network-coaxial-ceiling-speaker.jpg?size=380x0",
  },
  {
    id: 12,
    ...
    description:
      "Amber series powered speakers are designed for intelligent network systems.",
    image:
      "https://www.tendzone.net/uploads/43135/small/8-vailink-network-coaxial-ceiling-speaker.jpg?size=380x0",
  },
];
