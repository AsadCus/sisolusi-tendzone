...
const PRODUCTS: Product[] = [
  {
    ...
    description:
      "High-performance professional switching device that effectively manages audio and video signals.",
    image:
      "https://www.tendzone.net/uploads/43135/small/hybrid-modular-video-matrix557ba.jpg?size=380x0",
  ...
  },
  {
    ...
    description:
      "High-performance 4K HDMI seamless switching matrix for professional AV environments.",
    image:
      "https://www.tendzone.net/uploads/43135/small/fixed-seamless-video-matrixac1a6.jpg?size=380x0",
  ...
  },
  {
    ...
    description:
      "Professional 4K HD fixed seamless switching matrix with 8 inputs and 8 outputs.",
    image:
      "https://www.tendzone.net/uploads/43135/small/8x8-fixed-seamless-video-matrix5bf8c.jpg?size=380x0",
    badge: { label: "Best Selling", type: "bestselling" },
  },
  {
    id: 4,
    ...
    description:
      "Professional 4K HD fixed seamless switching matrix supporting 4 inputs and 4 outputs.",
    image:
      "https://www.tendzone.net/uploads/43135/small/4x4-fixed-seamless-video-matrixdddf2.jpg?size=380x0",
  ...
  },
  {
    ...
    description:
      "Advanced modular design with flexible I/O configuration for large-scale installations.",
    image:
      "https://www.tendzone.net/uploads/43135/small/hybrid-modular-video-matrix557ba.jpg?size=380x0",
  },
  {
    ...
    description:
      "Enterprise-grade 16x16 seamless switching matrix for command centers and studios.",
    image:
      "https://www.tendzone.net/uploads/43135/small/fixed-seamless-video-matrixac1a6.jpg?size=380x0",
  ...
  },
  {
    ...
    description:
      "HD variant of the 8x8 matrix with enhanced color processing and low latency output.",
    image:
      "https://www.tendzone.net/uploads/43135/small/8x8-fixed-seamless-video-matrix5bf8c.jpg?size=380x0",
  },
  {
    ...
    description:
      "Compact form factor matrix ideal for portable setups and small venue installations.",
    image:
      "https://www.tendzone.net/uploads/43135/small/4x4-fixed-seamless-video-matrixdddf2.jpg?size=380x0",
    badge: { label: "Hot", type: "hot" },
  },
