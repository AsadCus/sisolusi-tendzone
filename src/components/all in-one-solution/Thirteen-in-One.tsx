...
const SECTIONS: SpecSection[] = [
  {
    ...
    rows: [
      ...
      {
        key: "S/N ratio @ A weighted, 4 V Output, 2 V MASTER inputs",
        val: "104 dBA",
      },
      {
        key: "S/N ratio @ A weighted, 4 V Output, 2 V AUX input",
        val: "105 dBA",
      },
      {
        key: "S/N ratio @ A weighted, 4 V Output, OPTICAL IN1/IN2 input",
        val: "110 dBA",
      },
  ...
  },
  {
    ...
    rows: [
      ...
      {
        key: "Input impedance Speaker In / AUX / Pre In",
        val: "15 kΩ (Pre IN / AUX) · 5 Ω (Speaker IN)",
      },
    ],
  },
  {
    ...
    rows: [
      {
        key: "Low level (Pre)",
        val: "Ch1 ÷ Ch13 (IIR mode); Ch1 ÷ Ch9 (FIR mode)",
      },
      { key: "Max Output Level 0.1% THD", val: "4 V" },
      { key: "Digital AD Link 1", val: "Ch1 ÷ Ch8 (IIR / FIR mode)" },
      {
        key: "Digital AD Link 2",
        val: "Ch9 ÷ Ch13 (IIR mode); Ch9 only (FIR mode)",
      },
    ],
  },
  {
    ...
    rows: [
      ...
      {
        key: "To Audison Amplifiers",
        val: "2 x (AC Link / AD LINK) control bus",
      },
  ...
  },
  {
    ...
    rows: [
      {
        key: "High Level Inputs (Speaker In)",
        val: "Automatic De-Equalization, Delay Compensation, All Pass Compensation, Polarity Check",
      },
      {
        key: "AUX Input",
        val: "Parametric Equalizer: +12 dB ÷ -15 dB · 10 poles FIR type",
      },
      {
        key: "OPTICAL IN1 / IN2 Inputs",
        val: "Parametric Equalizer: +12 dB ÷ -15 dB · 10 poles FIR type",
      },
      {
        key: "Outputs",
      ...
      {
        key: "Main EQ",
        val: "Parametric EQ +12 / -15 dB · 5 poles FIR + 1 pole IIR",
      },
      {
        key: "Dynamic Equalization",
        val: "Self-adjusting system between low and high listening levels",
      },
      {
        key: "Bass Boost",
        val: "Adjustable parametric pole (±12 dB; 10 ÷ 500 Hz)",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rows: [
      ...
      {
        key: "Software / PC requirements",
        val: "Microsoft Windows (32/64 bit): XP, Vista, Windows 7, Windows 8, Windows 10",
      },
    ...
    rows: [
      {
        ...
        val: '148 × 43.6 × 233 mm / 5.82" × 1.7" × 9.17"',
      },
...
function Row({
  ...
  return (
    <div
      className={`border-b ${even ? "bg-gray-50" : "bg-white"} hover:bg-gray-100`}
    >
      {/* Desktop */}
