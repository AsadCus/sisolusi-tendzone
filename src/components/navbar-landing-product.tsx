...
const productCategories = [
  ...
  { category: "Wireless Microphone System", href: "/wireless-microphone-system" },
  { category: "Microphone", href: "/microphone" },
  { category: "Power Amplifier", href: "/power-amplifer" },
  { category: "Speaker", href: "/speaker" },
  { category: "Audio Accessories", href: "/audio-accessories" },
      ...
      <div className="font-sans">
        ...
        <header className="fixed top-0 left-0 w-full z-200 flex flex-col">
          ...
          <div className={cn(
            ...
            isTransparent
              ? "bg-black border-b border-white/10 h-9 opacity-100"
              : scrolled
                ? "h-0 opacity-0"
          ...
          <nav className={cn(
            ...
            isTransparent ? "bg-black" : "bg-white shadow-sm border-b border-gray-100"
          )}>
