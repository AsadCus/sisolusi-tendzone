...
const points = [
  {
    ...
    title: "UHF-TV Band",
    description:
      "Unused television channels in this range are available for wireless microphones and other wireless audio devices. Most cities have a significant number of television stations and the largest cities may also have public safety operations, but there are sufficient unused television channels available for most wireless users to find a clear channel. Users may be licensed or unlicensed in the UHF Band.",
  },
  {
    icon: Signal,
    tag: "02",
    title: "900 MHz Range",
    description:
      "This band (specifically, 902–928 MHz) offers additional channels outside of the TV channel range. Users are allowed to operate without a license in this range. There are several high quality wireless microphone systems that operate in this range, most of them fully digital.",
  },
  {
    icon: Wifi,
    tag: "03",
    title: "2.4 GHz Band",
    description:
      "Advantages of this band are: worldwide, license-free operation, and very short antennas, but there is some potential for interference from Wi-Fi devices.",
  },
];
