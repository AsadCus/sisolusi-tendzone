...
const categories: Category[] = [
  ...
  {
    id: 4,
      name: "4CH 4K60 4:4:4 HDR HDMI Distributor",
      description: "It supports HDMI video resolutions up to 4K@60Hz 4:4:4, HDR10, Dolby Vision,",
    image: "https://www.tendzone.net/uploads/43135/small/4ch-4k60-4-4-4-hdr-hdmi-distributored7e8.jpg?size=380x0",
    slug: "all-in-one",
    badge: "Best Selling",
    badgeType: "bestselling",
    logo: "/icon.png",
