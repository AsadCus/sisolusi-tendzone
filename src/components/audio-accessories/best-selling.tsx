...
const PRODUCTS: Product[] = [
  { id: 1, name: "2CH 2K60 4:4:4 Network AV Encoder/Decoder", slug: "all-in-one", description: "The Tendzone SKY-2622 is a multimedia distributed interactive system for professional AV environments.", image: "https://www.tendzone.net/uploads/43135/small/control-panel-with-knobc69e0.jpg?size=380x0", badge: { label: "Best Selling", type: "bestselling" } },
  { id: 2, name: "2K60 4:4:4 Network AV Encoder/Decoder", slug: "all-in-one", description: "The Tendzone SKY-2611 is a multimedia distributed interactive system for seamless AV distribution.", image: "https://www.tendzone.net/uploads/43135/small/control-panel-with-knobs-and-buttons8b6ec.jpg?size=380x0", badge: { label: "Best Selling", type: "bestselling" } },
  { id: 3, name: "8K60 Network AV Encoder/Decoder", slug: "all-in-one", description: "The Tendzone SKY-8611 is a multimedia distributed interactive system supporting 8K60 resolution.", image: "https://www.tendzone.net/uploads/43135/small/dante-2ch-analog-input-adapter7e2c1.jpg?size=380x0", badge: { label: "Best Selling", type: "bestselling" } },
];
...
export default function BestSellingAudioAccessories() {
  return (
        ...
        <div className="max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-xl font-medium text-red-600">
              Our Best-Selling Audio Accessories
            </h2>
