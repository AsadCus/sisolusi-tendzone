...
const PRODUCTS: Product[] = [
  { id: 1, name: "2CH 2K60 4:4:4 Network AV Encoder/Decoder", slug: "all-in-one", description: "The Tendzone SKY-2622 is a multimedia distributed interactive system.", image: "https://www.tendzone.net/uploads/43135/small/control-panel-with-knobc69e0.jpg?size=380x0", badge: { label: "Best Selling", type: "bestselling" } },
  { id: 2, name: "2K60 4:4:4 Network AV Encoder/Decoder", slug: "all-in-one", description: "The Tendzone SKY-2611 is a multimedia distributed interactive system.", image: "https://www.tendzone.net/uploads/43135/small/control-panel-with-knobs-and-buttons8b6ec.jpg?size=380x0", badge: { label: "Best Selling", type: "bestselling" } },
  { id: 3, name: "8K60 Network AV Encoder/Decoder", slug: "all-in-one", description: "The Tendzone SKY-8611 is a multimedia distributed interactive system.", image: "https://www.tendzone.net/uploads/43135/small/dante-2ch-analog-input-adapter7e2c1.jpg?size=380x0", badge: { label: "Best Selling", type: "bestselling" } },
  { id: 4, name: "4K AV Over IP Encoder Decoder", slug: "all-in-one", description: "The Tendzone MCN-4611 is a multimedia distributed interactive system.", image: "https://www.tendzone.net/uploads/43135/small/dante-adapter-usb-to-i-o03e0f.jpg?size=380x0", badge: { label: "Best Selling", type: "bestselling" } },
  { id: 5, name: "Expansion MIDIS System Server", slug: "all-in-one", description: "The Tendzone MCU-1000 platform is the server of MIDIS AV over IP system.", image: "https://www.tendzone.net/uploads/43135/small/4x3-dante-aes67-wall-panel-with-bluetooth99397.jpg?size=380x0", badge: { label: "Best Selling", type: "bestselling" } },
];
